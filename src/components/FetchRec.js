...
class FetchRec extends React.Component {
    ...
    componentDidMount() {
        ...
        if(this.props.acousticness<0.15) {
            ...
            acoustic = "&min_acousticness="+String(this.props.acousticness-0.15)+"&max_acousticness="+String(this.props.acousticness+0.15)
        }
        ...
        if(this.props.energy<0.15) {
            ...
            energy = "&min_energy="+String(this.props.energy-0.15)+"&max_energy="+String(this.props.energy+0.15)
        }
        ...
        if(this.props.liveness<0.15) {
            ...
            liveness = "&min_liveness="+String(this.props.liveness-0.15)+"&max_liveness="+String(this.props.liveness+0.15)
        }
        ...
        if(this.props.danceability<0.15) {
            ...
            dance = "&min_danceability="+String(this.props.danceability-0.15)+"&max_danceability="+String(this.props.danceability+0.15)
        }

...
class MusicCard extends React.Component {
  ...
  sendLog() {
    ...
    var raw = JSON.stringify({
      ...
      musica:
        this.props.musica.name + ' por ' + this.props.musica.artists[0].name,
      correct: this.state.correctDate,
      guess: this.state.date,
    });
    // console.log(raw)
    var requestOptions = {
      method: 'POST',
    ...
    fetch('https://spotify-app-back.herokuapp.com/save', requestOptions) //https://spotify-app-back.herokuapp.com/save to run locally
    ...
    if (this.state.submission === false) {
      ...
      return (
        <div className='titulos'>
          <h3>
            Música: {this.props.musica.name} por{' '}
            {this.props.musica.artists[0].name}
          </h3>

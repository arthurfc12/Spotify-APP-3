...
class Log extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      'https://spotify-app-back.herokuapp.com/tentativas/' +
        String(this.props.id),
      requestOptions
    ) //https://spotify-app-back.herokuapp.com/tentativas/ to run locally
        ...
        return (
          <div className='titulos'>
            ...
            {recArray.map(function (d, idx) {
              return (
                <li className='lista'>
                  {d.musica}: Seu chute {d.guess} >> Correto {d.correct}
                </li>
              );
            })}
          </div>
